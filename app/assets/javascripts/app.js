!function () {
    "use strict";
    angular.module("app", ["ngRoute", "ngAnimate", "ngAria", "ui.bootstrap", "ui.tree", "ngTagsInput", "textAngular", "angular-loading-bar", "duScroll", "app.nav", "app.i18n", "app.chart", "app.ui", "app.ui.form", "app.ui.form.validation", "app.page", "app.table", "app.task"])
}(), function () {
    "use strict";
    ...
    function a(a, b, c, d, e) {
        var f;
        f = a.tasks = b.get(), a.newTask = "", a.remainingCount = c(f, {completed: !1}).length, a.editedTask = null, a.statusFilter = {completed: !1}, a.filter = function (b) {
            switch (b) {
                case"all":
                    return a.statusFilter = "";
                case"active":
                    return a.statusFilter = {completed: !1};
                case"completed":
                    return a.statusFilter = {completed: !0}
            }
        }, a.add = function () {
            var c;
    ...
    function a(a, b) {
        ...
        a.line1 = {}, a.line2 = {}, a.line3 = {}, a.line4 = {}, a.bar1 = {}, a.bar2 = {}, a.bar3 = {}, a.bar4 = {}, a.bar5 = {}, a.pie1 = {}, a.pie2 = {}, a.pie4 = {}, a.scatter1 = {}, a.scatter2 = {}, a.radar1 = {}, a.radar2 = {}, a.gauge1 = {}, a.chord1 = {}, a.funnel1 = {}, a.line1.options = {
            ...
            toolbox: {
                show: !0,
                feature: {restore: {show: !0, title: "restore"}, saveAsImage: {show: !0, title: "save as image"}}
            },
            calculable: !0,
            xAxis: [{
                type: "category",
            ...
            series: [{
                ...
                type: "line",
                data: [1, -2, 2, 5, 3, 2, 0],
                markPoint: {data: [{name: "Lowest temperature", value: -2, xAxis: 1, yAxis: -1.5}]},
                markLine: {data: [{type: "average", name: "Average"}]}
            }]
        }, a.line2.options = {
            tooltip: {trigger: "axis"},
            ...
            legend: {data: ["Direct", "Email", "Affiliate", "Video Ads", "Search", "Baidu", "Google", "Bing", "Others"]},
            calculable: !0,
            xAxis: [{type: "category", data: ["Mon.", "Tue.", "Wed.", "Thu.", "Fri.", "Sat.", "Sun."]}],
            yAxis: [{type: "value"}],
            series: [{name: "Direct", type: "bar", data: [320, 332, 301, 334, 390, 330, 320]}, {
                name: "Email",
                type: "bar",
                stack: "Ads",
                data: [120, 132, 101, 134, 90, 230, 210]
            ...
            series: [{name: "2011", type: "bar", data: [18203, 23489, 29034, 104970, 131744, 630230]}, {
                name: "2012",
                type: "bar",
            ...
            tooltip: {trigger: "axis", axisPointer: {type: "shadow"}},
            legend: {data: ["Direct", "Email", "Affiliate", "Video Ads", "Search"]},
            toolbox: {
                show: !0,
                feature: {restore: {show: !0, title: "restore"}, saveAsImage: {show: !0, title: "save as image"}}
            },
            ...
            legend: {orient: "vertical", x: "left", data: ["Direct", "Email", "Affiliate", "Video Ads", "Search"]},
            toolbox: {
                show: !0,
                feature: {restore: {show: !0, title: "restore"}, saveAsImage: {show: !0, title: "save as image"}}
            },
            ...
            series: [{
                ...
                data: [{value: 335, name: "Direct"}, {value: 310, name: "Email"}, {
                    value: 234,
                    name: "Affiliate"
                }, {value: 135, name: "Video Ads"}, {value: 1548, name: "Search"}]
            }]
        }, a.pie2.options = {
            tooltip: {trigger: "item", formatter: "{a} <br/>{b} : {c} ({d}%)"},
            legend: {orient: "vertical", x: "left", data: ["Direct", "Email", "Affiliate", "Video Ads", "Search"]},
            ...
            series: [{
                ...
                itemStyle: {
                    ...
                    emphasis: {label: {show: !0, position: "center", textStyle: {fontSize: "30", fontWeight: "bold"}}}
                },
                data: [{value: 335, name: "Direct"}, {value: 310, name: "Email"}, {
                    value: 234,
                    name: "Affiliate"
            ...
            series: [{
                ...
                data: [{value: 10, name: "rose1"}, {value: 5, name: "rose2"}, {value: 15, name: "rose3"}, {
                    value: 25,
                    name: "rose4"
                }, {value: 20, name: "rose5"}, {value: 35, name: "rose6"}, {value: 30, name: "rose7"}, {
                    value: 40,
                    name: "rose8"
                }]
            }, {
            ...
            title: {text: "Height and weight distribution", subtext: "Data: Heinz  2003"},
            tooltip: {
                trigger: "axis", showDelay: 0, formatter: function (a) {
            ...
            series: [{
                name: "scatter1", type: "scatter", symbolSize: function (a) {
                    return Math.round(a[2] / 5)
                }, data: d()
            }, {
                name: "scatter2", type: "scatter", symbolSize: function (a) {
                    return Math.round(a[2] / 5)
                }, data: d()
            }]
        }, a.radar1.options = {
            ...
            calculable: !0,
            polar: [{
                indicator: [{text: "Attack", max: 100}, {text: "Guard", max: 100}, {
                    text: "Physical",
                    max: 100
                }, {text: "Speed", max: 100}, {text: "Strength", max: 100}, {text: "Skill", max: 100}], radius: 130
            }],
            series: [{
                name: "Full of live data",
                type: "radar",
                itemStyle: {normal: {areaStyle: {type: "default"}}},
                data: [{value: [97, 42, 88, 94, 90, 86], name: "Andriy Shevchenko"}, {
            ...
            title: {text: "Test Data", subtext: "From d3.js", x: "right", y: "bottom"},
            tooltip: {
            ...
            series: [{
                ...
                type: "funnel",
                width: "40%",
                data: [{value: 60, name: "Vist"}, {value: 40, name: "Contact"}, {value: 20, name: "Order"}, {
                    value: 80,
                    name: "Click"
    ...
    function a(a, b, c, d) {
        ...
        a.main = {brand: "Slim", name: "Lisa", year: f}, a.pageTransitionOpts = [{
            name: "Fade up",
            "class": "animate-fade-up"
        }, {name: "Scale up", "class": "ainmate-scale-up"}, {
            name: "Slide in from right",
            "class": "ainmate-slide-in-right"
        }, {name: "Flip Y", "class": "animate-flip-y"}], a.admin = {
            layout: "wide",
            menu: "vertical",
            fixedHeader: !0,
            fixedSidebar: !0,
    ...
    angular.module("app").config(["$routeProvider", function (a) {
        var b, c;
        b = ["dashboard", "ui/typography", "ui/buttons", "ui/icons", "ui/grids", "ui/widgets", "ui/components", "ui/boxes", "ui/timeline", "ui/nested-lists", "ui/pricing-tables", "ui/maps", "table/static", "table/dynamic", "table/responsive", "form/elements", "form/layouts", "form/validation", "form/wizard", "chart/echarts", "chart/echarts-line", "chart/echarts-bar", "chart/echarts-pie", "chart/echarts-scatter", "chart/echarts-more", "page/404", "page/500", "page/blank", "page/forgot-password", "page/invoice", "page/lock-screen", "page/profile", "page/invoice", "page/signin", "page/signup", "app/tasks", "app/calendar"], c = function (b) {
            var c, d;
            return d = "/" + b, c = {templateUrl: "app/" + b + ".html"}, a.when(d, c), a
        }, b.forEach(function (a) {
            return c(a)
        }), a.when("/", {redirectTo: "/dashboard"}).when("/dashboard", {templateUrl: "app/dashboard/dashboard.html"}).when("/404", {templateUrl: "app/page/404.html"}).otherwise({redirectTo: "/404"})
    }])
}(), function () {
    function a(a) {
    ...
    function a(a) {
        ...
        a.pie1 = {}, a.pie1.options = {
            animation: !0,
            title: {text: "Traffic Source", x: "left"},
            tooltip: {trigger: "item", formatter: "{a} <br/>{b} : {c} ({d}%)"},
            calculable: !0,
            series: [{
                name: "Vist source",
                ...
                data: [{
                    ...
                    itemStyle: {
                        normal: {
                            ...
                            label: {show: !0, textStyle: {color: a.color.success}},
                            labelLine: {show: !0, lineStyle: {color: a.color.success}}
                        }
                    }
                }, {
                    value: 310,
                    ...
                    itemStyle: {
                        normal: {
                            ...
                            label: {show: !0, textStyle: {color: a.color.infoAlt}},
                            labelLine: {show: !0, lineStyle: {color: a.color.infoAlt}}
                        }
                    }
                }, {
                    value: 135,
                    ...
                    itemStyle: {
                        normal: {
                            ...
                            label: {show: !0, textStyle: {color: a.color.warning}},
                            labelLine: {show: !0, lineStyle: {color: a.color.warning}}
                        }
                    }
                }, {
                    value: 1548,
                    ...
                    itemStyle: {
                        normal: {
                            color: a.color.info,
                            label: {show: !0, textStyle: {color: a.color.info}},
                            labelLine: {show: !0, lineStyle: {color: a.color.info}}
                        }
                    }
                }]
            }]
            ...
            series: [{
                name: "scatter1", type: "scatter", symbolSize: function (a) {
                    return Math.round(a[2] / 5)
                }, itemStyle: {normal: {color: "rgba(107,188,215,.5)"}}, data: c()
            }, {
                name: "scatter2", type: "scatter", symbolSize: function (a) {
                    return Math.round(a[2] / 5)
                }, itemStyle: {normal: {color: "rgba(129,202,128,.5)"}}, data: c()
            }]
        }
    }
    ...
    function b(a) {
        a.today = function () {
            ...
            var b;
            a.minDate = null != (b = a.minDate) ? b : {"null": new Date}
    ...
    angular.module("app.ui.form").directive("uiRangeSlider", a).directive("uiFileUpload", b).directive("uiWizardForm", c)
}(), function () {
    "use strict";
    function a(a) {
        var b;
    ...
    function b(a) {
        var b;
        a.user = {email: "", password: ""}, a.showInfoOnSubmit = !1, b = angular.copy(a.user), a.revert = function () {
    ...
    function c() {
        ...
        var b = {restrict: "A", controller: ["$scope", "$element", "$attrs", "$location", a]};
        return b
    }
    ...
    function a() {
        ...
        var b = {restrict: "A", controller: ["$scope", "$element", "$location", a]};
        return b
    }
    ...
    function a(a, b) {
        var c;
        a.stores = [{name: "Nijiya Market", price: "$$", sales: 292, rating: 4}, {
    ...
    function c(a) {
        a.alerts = [{
            ...
            return a.alerts.push({type: c, msg: "Another alert!"})
    ...
    function h(a, b, c) {
        a.items = c, a.selected = {item: a.items[0]}, a.ok = function () {
    ...
    function k(a) {
        a.list = [{id: 1, title: "Item 1", items: []}, {
            id: 2,
            title: "Item 2",
            items: [{
                id: 21,
    ...
    function l(a, b, c) {
        var d, e;
        for (e = [], d = 0; 8 > d;)e[d] = new google.maps.Marker({title: "Marker: " + d}), d++;
    ...
    function c() {
        return {
            restrict: "A", link: function (a, b, c) {
                return b.slimScroll({height: c.scrollHeight || "100%"})
            }
        }
    }
