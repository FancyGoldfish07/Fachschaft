...
RSpec.describe EventCategoriesController, type: :controller do
  ...
  # EventCategoriesController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET #index" do
    it "assigns all event_categories as @event_categories" do
      ...
      expect(assigns(:event_categories)).to eq([event_category])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested event_category as @event_category" do
      event_category = EventCategory.create! valid_attributes
      get :show, {:id => event_category.to_param}, valid_session
      expect(assigns(:event_category)).to eq(event_category)
    end
  end

  describe "GET #new" do
    it "assigns a new event_category as @event_category" do
  ...
  describe "GET #edit" do
    it "assigns the requested event_category as @event_category" do
      event_category = EventCategory.create! valid_attributes
      get :edit, {:id => event_category.to_param}, valid_session
      expect(assigns(:event_category)).to eq(event_category)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new EventCategory" do
        expect {
          post :create, {:event_category => valid_attributes}, valid_session
      ...
      it "redirects to the created event_category" do
        post :create, {:event_category => valid_attributes}, valid_session
        expect(response).to redirect_to(EventCategory.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved event_category as @event_category" do
        post :create, {:event_category => invalid_attributes}, valid_session
        expect(assigns(:event_category)).to be_a_new(EventCategory)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested event_category" do
        event_category = EventCategory.create! valid_attributes
        put :update, {:id => event_category.to_param, :event_category => new_attributes}, valid_session
      ...
      it "assigns the requested event_category as @event_category" do
        event_category = EventCategory.create! valid_attributes
        put :update, {:id => event_category.to_param, :event_category => valid_attributes}, valid_session
        expect(assigns(:event_category)).to eq(event_category)
      end
      ...
      it "redirects to the event_category" do
        event_category = EventCategory.create! valid_attributes
        put :update, {:id => event_category.to_param, :event_category => valid_attributes}, valid_session
        expect(response).to redirect_to(event_category)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the event_category as @event_category" do
        event_category = EventCategory.create! valid_attributes
        put :update, {:id => event_category.to_param, :event_category => invalid_attributes}, valid_session
        expect(assigns(:event_category)).to eq(event_category)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested event_category" do
      event_category = EventCategory.create! valid_attributes
      expect {
        delete :destroy, {:id => event_category.to_param}, valid_session
      }.to change(EventCategory, :count).by(-1)
    end
